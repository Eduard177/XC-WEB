    ...
    <section>
      ...
      <div class="flex flex-col mt-4">
        <div
          ...
          class="flex justify-around items-center bg-white shadow-md rounded-lg cursor-pointer py-2"
        >
      ...
      <div class="flex flex-col mt-4">
        <div
          class="flex justify-around items-center bg-white shadow-md rounded-lg cursor-pointer py-2 mt-2"
        >
          <figure class="flex justify-center items-center w-16 bg-hueso rounded-full">
            <img
              class="rounded-full object-cover"
      ...
      <div class="flex flex-col py-8 px-2">
        <div class="flex">
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-1/2 flex flex-col my-3 pr-6">
              <span class="border-solid border-b border-black">Pro Consumidor - Xpertcode</span>
              <label for>Lugar</label>
            </div>
            <div class="w-1/2 flex flex-col my-3 pr-6">
